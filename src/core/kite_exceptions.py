...
from kiteconnect.exceptions import (
    KiteException, TokenException, InputException,
    NetworkException, PermissionException, OrderException,
    GeneralException, DataException
)
import logging
    ...
    def get_graceful_response(
        ...
        if KiteErrorHandler.is_token_expired(error):
            ...
            if include_refresh_url:
                response["action_required"] = {
                    ...
                    "ui_tool": "Open src/ui/token/simple_token_ui.html in browser for easy refresh"
                }
        ...
        # Handle other Kite exceptions
            ...
            return {
                ...
                "message": "Unable to connect to Kite servers. Please check your internet connection.",
                "details": {
                    "context": context,
                    "error_message": error_msg,
