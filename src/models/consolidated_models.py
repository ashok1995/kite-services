...
class ConsolidatedStockData(BaseModel):
    ...
    data_sources: Dict[str, DataSource] = Field(
        default_factory=dict, description="Data sources used"
    )
...
class ConsolidatedMarketContext(BaseModel):
    ...
    sector_performance: Dict[str, Decimal] = Field(
        default_factory=dict, description="Sector performance"
    )
...
class ConsolidatedMarketDataResponse(BaseModel):
    ...
    historical: Optional[Dict[str, ConsolidatedHistoricalData]] = Field(
        None, description="Historical data"
    )
...
class ServiceHealthResponse(BaseModel):
    ...
    external_apis_status: Dict[str, str] = Field(
        default_factory=dict, description="External API status"
    )
