    ...
    def __init__(self, logger: Optional[Any] = None):
        ...
        self.logger.info(
            ...
            extra={
                ...
                "api_key": self.settings.kite.api_key[:8] + "..." if self.settings.kite.api_key else "not_set",
    ...
    def generate_access_token(self, request_token: str) -> Dict[str, Any]:
        ...
        try:
            ...
            data = self.kite.generate_session(
                ...
                api_secret=self.settings.kite.api_secret
            )
            ...
            token_data = {
                ...
                "expires_at": (datetime.now() + timedelta(hours=24)).isoformat()  # Kite tokens expire daily
            }
